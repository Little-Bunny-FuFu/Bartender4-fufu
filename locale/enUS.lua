-- Bartender4 Locale
-- Forked version for Bartender4-fufu
...
L["Show Spell Cast VFX on action buttons"] = true
L["Show the keyring button."] = true
L["Show the Reagent Bag in One Bag mode"] = true
L["Shows the miniature cast bar on action buttons when casting spells."] = true
...
-- Bartender4-fufu custom strings
L["Copy Keybinds from Character"] = true
L["Copy Bartender4 keybindings from another character. The source character must have logged in at least once with this version of Bartender4.\n"] = true
L["Source Character"] = true
L["Select the character to copy keybindings from."] = true
L["Copy Keybinds"] = true
L["Copy keybindings from the selected character. This will overwrite your current Bartender4 keybindings."] = true
L["Are you sure you want to overwrite your current keybindings with those from %s? This cannot be undone."] = "Overwrite your current keybindings with those from %s? This replaces all Bartender4 keybinds on this character. Any non-Bartender4 binding currently sitting on a key that the source uses will also be unbound. Cannot be undone."
L["Keybindings copied from %s."] = true
L["Could not copy keybindings from %s."] = true
L["Cannot copy keybindings during combat."] = true
L["Error: Character data not found for %s."] = true
L["Error: No saved bindings found for %s."] = true
L["Character Specific Keybinds"] = true
L["Use character-specific keybindings for this character instead of the account-wide keybindings.\n\nThe first time you switch this on, your current account bindings are copied to the character set so you don't start from scratch."] = true
L["Copy Character Keybinds to Account"] = true
L["Save your current character-specific keybindings into the account set as well, so toggling Character Specific Keybinds OFF will preserve them. Overwrites your existing account-wide keybindings."] = true
L["This will overwrite your account-wide keybindings with your current character-specific keybindings. Continue?"] = true
L["Keybindings copied from %s (%d failed)."] = true
L["Binding set changed since this dialog was opened; keybind copy cancelled."] = true
L["Per-character keybinds are not supported on this WoW client."] = true
